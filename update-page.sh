...
exec python2.7 $PLANETPLANET_DIRECTORY/planet.py $PLANETPLANET_DIRECTORY/gezegen-kisisel/config.ini
exec python2.7 $PLANETPLANET_DIRECTORY/planet.py $PLANETPLANET_DIRECTORY/gezegen-planet/config.ini
